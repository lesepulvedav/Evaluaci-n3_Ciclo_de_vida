1. Se cargaron los primeros archivos del proyecto de tienda de lacteos.
2. Se agrega el archivo dockerfile.
3. Se crea el archivo main.yml para las funciones de Actions.
